...
function checkAnswer() {
  ...
  if (
    ...
    document.getElementById("final-rx").innerHTML = "";
    ...
    document.getElementById("final-rx").innerHTML =
      "<b>R(x) = 9x<sup>4</sup> + 13x<sup>3</sup> + 3x<sup>2</sup> + 6x + 9</b>";
...
var setEquations = function () {
  document.getElementById("expr1").innerHTML =
    "<b>P(x) = 9x<sup>4</sup> + 13x<sup>3</sup> + 6</b>";
  document.getElementById("expr2").innerHTML =
    "<b>Q(x) = 3x<sup>2</sup> + 6x + 3</b>";
